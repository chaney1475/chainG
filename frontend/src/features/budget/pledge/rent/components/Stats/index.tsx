...
export function Stats() {
  ...
  const status = rentInfo?.currentMonth.find((item) => item.userId === userId)?.status
        ...
        <ContentContainer>
          ...
          <TextContainer>
            ...
            <TextBox>
              ...
              <DisabledColorText> 
                {contractInfo?.rent.userPaymentInfo.find(member => member.userId === userId)?.ratio} / {contractInfo?.rent.totalRatio}
                </DisabledColorText>
            </TextBox>
            <TextBox>
