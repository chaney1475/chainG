...
contract RentManager {
    ...
    mapping(uint256 => Rent[]) private accountTransactions;

    // 전체 거래 내역을 저장하기 위한 배열
    Rent[] private allTransactions;
    ...
    function addTransaction(
        ...
        Rent memory newTransaction = Rent({
            id: _id,
     ...
     */
    function getTransactionsByAccount(uint256 _accountId) public view returns (Rent[] memory) {
     ...
     */
    function getAllTransactions() public view returns (Rent[] memory) {
